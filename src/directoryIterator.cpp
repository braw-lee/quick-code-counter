...
std::vector<fs::path> directoryIterator(fs::path& targetDirectory, std::vector<std::string>& ignoreThem, bool ignoreHiddenFiles)
{
	...
	{
		//if the flag is on, ignore the file or directory
